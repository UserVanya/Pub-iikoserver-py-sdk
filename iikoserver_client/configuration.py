...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "iikoCookieAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = iikoserver_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://localhost:443/resto/api" if host is None else f"https://{host}:443/resto/api"
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("iikoserver_client")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'iikoCookieAuth' in self.api_key:
            auth['iikoCookieAuth'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'iikoCookieAuth',
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://{host}:{port}/{suffix}",
                'description': "iikoServer API",
                'variables': {
                    'host': {
                        'description': "The hostname of the iikoServer instance.",
