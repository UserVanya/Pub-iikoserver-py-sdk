...
class V2EntitiesProductScalesPostRequest(BaseModel):
    """
    V2EntitiesProductScalesPostRequest
    """ # noqa: E501
    ids: Optional[List[StrictStr]] = Field(default=None, description="Возвращаемые шкалы размеров должны иметь id из этого списка.")
    include_deleted: Optional[StrictBool] = Field(default=False, description="Включать ли в ответ удаленные элементы. По умолчанию false.", alias="includeDeleted")
    __properties: ClassVar[List[str]] = ["ids", "includeDeleted"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "V2EntitiesProductScalesPostRequest",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2EntitiesProductScalesPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2EntitiesProductScalesPostRequest from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of V2EntitiesProductScalesPostRequest from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of V2EntitiesProductScalesPostRequest from an XML element"""
