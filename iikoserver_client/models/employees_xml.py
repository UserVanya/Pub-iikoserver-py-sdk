...
class EmployeesXml(BaseModel):
    """
    EmployeesXml
    """ # noqa: E501
    employees: Optional[List[EmployeeXml]] = Field(default=None, description="Список сотрудников")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmployeesXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmployeesXml from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of EmployeesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of EmployeesXml from an XML element"""
