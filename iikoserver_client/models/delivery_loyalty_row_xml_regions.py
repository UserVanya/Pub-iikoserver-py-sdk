...
class DeliveryLoyaltyRowXmlRegions(BaseModel):
    """
    DeliveryLoyaltyRowXmlRegions
    """ # noqa: E501
    region: Optional[List[DeliveryLoyaltyRegionXml]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyRowXmlRegions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyRowXmlRegions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "region": [DeliveryLoyaltyRegionXml.from_dict(_item) for _item in obj["region"]] if obj.get("region") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyRowXmlRegions from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyRowXmlRegions from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        child_elements = element.findall("region")
        for child in child_elements:
            item_obj = DeliveryLoyaltyRegionXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "region")
