...
class AssemblyChartDeleteResponseScheme(BaseModel):
    """
    Результат операции удаления технологической карты
    """ # noqa: E501
    ...
    response: StrictStr = Field(description="UUID удалённой технологической карты")
    __properties: ClassVar[List[str]] = ["result", "errors", "response"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "AssemblyChartDeleteResponseScheme",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssemblyChartDeleteResponseScheme from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssemblyChartDeleteResponseScheme from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of AssemblyChartDeleteResponseScheme from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of AssemblyChartDeleteResponseScheme from an XML element"""
