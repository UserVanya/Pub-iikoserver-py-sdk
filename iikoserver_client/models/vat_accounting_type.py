...
class VatAccountingType(str, Enum):
    """
    Тип учета НДС. VAT_INCLUDED_IN_PRICE - НДС включен в цену покупки, VAT_NOT_INCLUDED_IN_PRICE - НДС не включен в цену покупки
    """

    """
    allowed enum values
    """
    VAT_INCLUDED_IN_PRICE = 'VAT_INCLUDED_IN_PRICE'
    VAT_NOT_INCLUDED_IN_PRICE = 'VAT_NOT_INCLUDED_IN_PRICE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VatAccountingType from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of VatAccountingType from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of VatAccountingType from an XML element"""
        if element is None:
            return None
