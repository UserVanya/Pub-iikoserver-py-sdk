...
class OfficialEmployeeDto(BaseModel):
    """
    OfficialEmployeeDto
    """ # noqa: E501
    role: Optional[OfficialEmployeeRoleDto] = None
    name: Optional[StrictStr] = Field(default=None, description="Имя.")
    __properties: ClassVar[List[str]] = ["role", "name"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "officialEmployeeDto",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OfficialEmployeeDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OfficialEmployeeDto from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of OfficialEmployeeDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of OfficialEmployeeDto from an XML element"""
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        if value is not None:  # Skip None values
            # Single element field: role
            child_element = SubElement(element, "role")
            # Enum field
