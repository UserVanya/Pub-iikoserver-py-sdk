...
class ProductWriteoffStrategy(str, Enum):
    """
    Метод списания продукта:  ASSEMBLE - Списывать ингредиенты. Этот способ обычно используется для полуфабрикатов и блюд, которые не нужно учитывать на складе.  DIRECT - Списывать сам продукт. Этот способ обычно используется для товаров и полуфабрикатов, остаток которых нужно учитывать на складе.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductWriteoffStrategy from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ProductWriteoffStrategy from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ProductWriteoffStrategy from an XML element"""
        if element is None:
            return None
