...
class ExternalDataEntryXml(BaseModel):
    """
    ExternalDataEntryXml
    """ # noqa: E501
    key: StrictStr = Field(description="Ключ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalDataEntryXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalDataEntryXml from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ExternalDataEntryXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ExternalDataEntryXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: key (XML name: key)
        # Handle XML element: key
        # Single element field: key
        child_element = element.find("key")
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        if value is not None:  # Skip None values
            # Single element field: key
            child_element = SubElement(element, "key")
