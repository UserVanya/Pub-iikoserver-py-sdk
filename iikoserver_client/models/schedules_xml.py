...
class SchedulesXml(BaseModel):
    """
    SchedulesXml
    """ # noqa: E501
    schedule: Optional[List[ScheduleXml]] = Field(default=None, description="Список смен")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SchedulesXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SchedulesXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "schedule": [ScheduleXml.from_dict(_item) for _item in obj["schedule"]] if obj.get("schedule") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of SchedulesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of SchedulesXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Array field: schedule
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("schedule")
        items = []
        for child in child_elements:
            item_obj = ScheduleXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "schedule")
