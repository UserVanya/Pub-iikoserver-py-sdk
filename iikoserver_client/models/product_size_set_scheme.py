...
class ProductSizeSetScheme(BaseModel):
    """
    ProductSizeSetScheme
    """ # noqa: E501
    id: StrictStr = Field(description="UUID размера")
    ...
    __properties: ClassVar[List[str]] = ["id", "disabled", "factors"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "ProductSizeSetScheme",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductSizeSetScheme from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductSizeSetScheme from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ProductSizeSetScheme from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ProductSizeSetScheme from an XML element"""
