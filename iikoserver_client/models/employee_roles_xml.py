...
class EmployeeRolesXml(BaseModel):
    """
    EmployeeRolesXml
    """ # noqa: E501
    role: List[EmployeeRoleXml] = Field(description="Список должностей сотрудников")
    __properties: ClassVar[List[str]] = ["role"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "employeeRoles",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmployeeRolesXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmployeeRolesXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "role": [EmployeeRoleXml.from_dict(_item) for _item in obj["role"]] if obj.get("role") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of EmployeeRolesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of EmployeeRolesXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: role (XML name: role)
        # Handle XML element: role
        # Array field: role
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("role")
        items = []
        for child in child_elements:
            item_obj = EmployeeRoleXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "role")
