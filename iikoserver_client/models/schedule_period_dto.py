...
class SchedulePeriodDto(BaseModel):
    """
    Период расписания
    """ # noqa: E501
    begin: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Время начала в формате HH:mm")
    end: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Время окончания в формате HH:mm")
    days_of_week: Optional[List[Annotated[int, Field(le=7, strict=True, ge=1)]]] = Field(default=None, description="Дни недели (1-7, где 1 - понедельник)", alias="daysOfWeek")
    __properties: ClassVar[List[str]] = ["begin", "end", "daysOfWeek"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "SchedulePeriodDto",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SchedulePeriodDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SchedulePeriodDto from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of SchedulePeriodDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of SchedulePeriodDto from an XML element"""
