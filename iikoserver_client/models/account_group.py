...
class AccountGroup(str, Enum):
    """
    Группа счета:  ASSETS - Активы LIABILITIES - Обязательства EQUITY - Капитал INCOME_EXPENSES - Доходы/Расходы
    """
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of AccountGroup from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of AccountGroup from an XML element"""
        if element is None:
            return None
