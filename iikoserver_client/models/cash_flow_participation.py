...
class CashFlowParticipation(str, Enum):
    """
    Участвует ли счет в ДДС:  CASH_FLOW - Участвует в ДДС NOT_CASH_FLOW - Не участвует в ДДС
    """
    ...
    """
    CASH_FLOW = 'CASH_FLOW'
    NOT_CASH_FLOW = 'NOT_CASH_FLOW'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CashFlowParticipation from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of CashFlowParticipation from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of CashFlowParticipation from an XML element"""
        if element is None:
            return None
