...
class DishDeletionType(str, Enum):
    """
    ...
    allowed enum values
    """
    DELETED_WITHOUT_WRITEOFF = 'DELETED_WITHOUT_WRITEOFF'
    DELETED_WITH_WRITEOFF = 'DELETED_WITH_WRITEOFF'
    NOT_DELETED = 'NOT_DELETED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DishDeletionType from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DishDeletionType from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DishDeletionType from an XML element"""
        if element is None:
            return None
