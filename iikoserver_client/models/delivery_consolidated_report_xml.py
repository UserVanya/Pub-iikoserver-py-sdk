...
class DeliveryConsolidatedReportXml(BaseModel):
    """
    DeliveryConsolidatedReportXml
    """ # noqa: E501
    rows: Optional[DeliveryConsolidatedReportXmlRows] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryConsolidatedReportXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryConsolidatedReportXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rows": DeliveryConsolidatedReportXmlRows.from_dict(obj["rows"]) if obj.get("rows") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryConsolidatedReportXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryConsolidatedReportXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        if child_element is not None:
            ...
            nested_obj = DeliveryConsolidatedReportXmlRows.from_xml_element(child_element)
