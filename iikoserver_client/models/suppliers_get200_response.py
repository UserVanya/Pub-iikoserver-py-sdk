...
class SuppliersGet200Response(BaseModel):
    """
    SuppliersGet200Response
    """ # noqa: E501
    employees: Optional[List[EmployeeXml]] = None
    __properties: ClassVar[List[str]] = ["employees"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SuppliersGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SuppliersGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "employees": [EmployeeXml.from_dict(_item) for _item in obj["employees"]] if obj.get("employees") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of SuppliersGet200Response from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of SuppliersGet200Response from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: employees (XML name: employee)
        # Handle XML element: employees
        # Array field: employees
        # Wrapped array - current element is the wrapper, look for items directly
        items = []
        # Complex items in wrapped array
        child_elements = element.findall("employee")
        for child in child_elements:
            item_obj = EmployeeXml.from_xml_element(child)
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: employees (XML name: employee)
        value = getattr(self, "employees", None)
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "employee")
