...
class DepartmentTypeEnum(str, Enum):
    """
    Тип подразделения:  CORPORATION - Корпорация JURPERSON - Юридическое лицо ORGDEVELOPMENT - Структурное подразделение DEPARTMENT - Торговое предприятие MANUFACTURE - Производство CENTRALSTORE - Центральный склад CENTRALOFFICE - Центральный офис SALEPOINT - Точка продаж STORE - Склад
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DepartmentTypeEnum from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DepartmentTypeEnum from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DepartmentTypeEnum from an XML element"""
        if element is None:
            return None
