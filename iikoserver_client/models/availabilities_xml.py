...
class AvailabilitiesXml(BaseModel):
    """
    AvailabilitiesXml
    """ # noqa: E501
    availability: Optional[List[AvailabilityXml]] = Field(default=None, description="Список отрезков доступности")
    __properties: ClassVar[List[str]] = ["availability"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "availabilities",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvailabilitiesXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvailabilitiesXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "availability": [AvailabilityXml.from_dict(_item) for _item in obj["availability"]] if obj.get("availability") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of AvailabilitiesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of AvailabilitiesXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: availability (XML name: availability)
        # Handle XML element: availability
        # Array field: availability
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("availability")
        items = []
        for child in child_elements:
            item_obj = AvailabilityXml.from_xml_element(child)
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: availability (XML name: availability)
        value = getattr(self, "availability", None)
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "availability")
