...
class PublicExternalDataXml(BaseModel):
    """
    PublicExternalDataXml
    """ # noqa: E501
    entry: Optional[List[ExternalDataEntryXml]] = Field(default=None, description="Записи внешних данных")
    __properties: ClassVar[List[str]] = ["entry"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "publicExternalData",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicExternalDataXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicExternalDataXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entry": [ExternalDataEntryXml.from_dict(_item) for _item in obj["entry"]] if obj.get("entry") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of PublicExternalDataXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of PublicExternalDataXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: entry (XML name: entry)
        # Handle XML element: entry
        # Array field: entry
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("entry")
        items = []
        for child in child_elements:
            item_obj = ExternalDataEntryXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "entry")
