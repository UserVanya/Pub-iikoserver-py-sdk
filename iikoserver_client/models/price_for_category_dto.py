...
class PriceForCategoryDto(BaseModel):
    """
    Цена для ценовой категории
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["categoryId", "price"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "PriceForCategoryDto",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriceForCategoryDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriceForCategoryDto from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of PriceForCategoryDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of PriceForCategoryDto from an XML element"""
