...
class OutgoingInvoiceListXml(BaseModel):
    """
    OutgoingInvoiceListXml
    """ # noqa: E501
    documents: Optional[List[OutgoingInvoiceXml]] = Field(default=None, description="Список расходных накладных")
    __properties: ClassVar[List[str]] = ["documents"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "outgoingInvoiceDtoes",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceListXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceListXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "documents": [OutgoingInvoiceXml.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceListXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceListXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = OutgoingInvoiceXml.from_xml_element(child)
