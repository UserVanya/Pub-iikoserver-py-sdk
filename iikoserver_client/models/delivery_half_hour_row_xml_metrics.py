...
class DeliveryHalfHourRowXmlMetrics(BaseModel):
    """
    DeliveryHalfHourRowXmlMetrics
    """ # noqa: E501
    metric: Optional[List[DeliveryHalfHourMetricXml]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourRowXmlMetrics from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.metric:
            for _item_metric in self.metric:
                if _item_metric:
                    _items.append(_item_metric.to_dict())
            _dict['metric'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourRowXmlMetrics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metric": [DeliveryHalfHourMetricXml.from_dict(_item) for _item in obj["metric"]] if obj.get("metric") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourRowXmlMetrics from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourRowXmlMetrics from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: metric (XML name: metric)
        # Handle XML element: metric
        # Array field: metric
        # Wrapped array - current element is the wrapper, look for items directly
        items = []
        # Complex items in wrapped array
        child_elements = element.findall("metric")
        for child in child_elements:
            item_obj = DeliveryHalfHourMetricXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "metric")
