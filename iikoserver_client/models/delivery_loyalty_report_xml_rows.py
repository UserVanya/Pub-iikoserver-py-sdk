...
class DeliveryLoyaltyReportXmlRows(BaseModel):
    """
    DeliveryLoyaltyReportXmlRows
    """ # noqa: E501
    row: Optional[List[DeliveryLoyaltyRowXml]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyReportXmlRows from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyReportXmlRows from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "row": [DeliveryLoyaltyRowXml.from_dict(_item) for _item in obj["row"]] if obj.get("row") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyReportXmlRows from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryLoyaltyReportXmlRows from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = DeliveryLoyaltyRowXml.from_xml_element(child)
