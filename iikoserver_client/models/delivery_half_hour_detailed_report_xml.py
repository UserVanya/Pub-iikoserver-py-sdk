...
class DeliveryHalfHourDetailedReportXml(BaseModel):
    """
    DeliveryHalfHourDetailedReportXml
    """ # noqa: E501
    rows: Optional[DeliveryHalfHourDetailedReportXmlRows] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourDetailedReportXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourDetailedReportXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rows": DeliveryHalfHourDetailedReportXmlRows.from_dict(obj["rows"]) if obj.get("rows") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourDetailedReportXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryHalfHourDetailedReportXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: rows (XML name: rows)
        # Handle XML element: rows
        # Single element field: rows
        child_element = element.find("rows")
        if child_element is not None:
            # Complex object field
            nested_obj = DeliveryHalfHourDetailedReportXmlRows.from_xml_element(child_element)
            if nested_obj is not None:
                data["rows"] = nested_obj
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: rows (XML name: rows)
        value = getattr(self, "rows", None)
        if value is not None:  # Skip None values
            # Single element field: rows
            child_element = SubElement(element, "rows")
            # Complex object field
