...
class DeliveryOrderCycleReportXmlRows(BaseModel):
    """
    DeliveryOrderCycleReportXmlRows
    """ # noqa: E501
    row: Optional[List[DeliveryOrderCycleRowXml]] = None
    __properties: ClassVar[List[str]] = ["row"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "DeliveryOrderCycleReportXmlRows",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryOrderCycleReportXmlRows from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryOrderCycleReportXmlRows from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "row": [DeliveryOrderCycleRowXml.from_dict(_item) for _item in obj["row"]] if obj.get("row") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryOrderCycleReportXmlRows from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryOrderCycleReportXmlRows from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = DeliveryOrderCycleRowXml.from_xml_element(child)
