...
class StoreReportPresetXmlColumnCaptions(BaseModel):
    """
    StoreReportPresetXmlColumnCaptions
    """ # noqa: E501
    i: Optional[List[KeyValueXml]] = None
    __properties: ClassVar[List[str]] = ["i"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "StoreReportPresetXmlColumnCaptions",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StoreReportPresetXmlColumnCaptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in i (list)
        _items = []
        if self.i:
            for _item_i in self.i:
                if _item_i:
                    _items.append(_item_i.to_dict())
            _dict['i'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StoreReportPresetXmlColumnCaptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "i": [KeyValueXml.from_dict(_item) for _item in obj["i"]] if obj.get("i") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of StoreReportPresetXmlColumnCaptions from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of StoreReportPresetXmlColumnCaptions from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: i (XML name: i)
        # Handle XML element: i
        # Array field: i
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("i")
        items = []
        for child in child_elements:
            item_obj = KeyValueXml.from_xml_element(child)
        ...
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "i")
