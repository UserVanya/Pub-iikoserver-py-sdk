...
class V2CorporationSettingsGet200Response(BaseModel):
    """
    V2CorporationSettingsGet200Response
    """ # noqa: E501
    vat_accounting: Optional[VatAccountingType] = Field(default=None, alias="vatAccounting")
    __properties: ClassVar[List[str]] = ["vatAccounting"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "V2CorporationSettingsGet200Response",
        
        
        "field_configs": {
            "vat_accounting": {
                "xml_name": "vatAccounting",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2CorporationSettingsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2CorporationSettingsGet200Response from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of V2CorporationSettingsGet200Response from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of V2CorporationSettingsGet200Response from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: vat_accounting (XML name: vatAccounting)
        # Handle XML element: vat_accounting
        # Single element field: vat_accounting
        child_element = element.find("vatAccounting")
        if child_element is not None:
            # Enum field
            text_value = child_element.text
            if text_value is not None and text_value.strip() != "" and text_value != "null":
                data["vatAccounting"] = text_value
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: vat_accounting (XML name: vatAccounting)
        value = getattr(self, "vat_accounting", None)
        if value is not None:  # Skip None values
            # Single element field: vat_accounting
            child_element = SubElement(element, "vatAccounting")
            # Enum field
