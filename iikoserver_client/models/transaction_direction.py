...
class TransactionDirection(str, Enum):
    """
    Дебет/Кредит:  DEBIT - Дебет CREDIT - Кредит
    """
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of TransactionDirection from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of TransactionDirection from an XML element"""
        if element is None:
            return None
