...
class ProductScalesOperationResponseScheme(BaseModel):
    """
    Результат операции с шкалами размеров
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductScalesOperationResponseScheme from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductScalesOperationResponseScheme from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": [ProductScaleDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ProductScalesOperationResponseScheme from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ProductScalesOperationResponseScheme from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        items = []
        for child in child_elements:
            item_obj = ProductScaleDto.from_xml_element(child)
            if item_obj is not None:
                items.append(item_obj)
        data["response"] = items
