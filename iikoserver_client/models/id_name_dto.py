...
class IdNameDto(BaseModel):
    """
    IdNameDto
    """ # noqa: E501
    id: StrictStr = Field(description="UUID сущности.")
    name: StrictStr = Field(description="Название сущности.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdNameDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdNameDto from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of IdNameDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of IdNameDto from an XML element"""
