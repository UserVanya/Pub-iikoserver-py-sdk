...
class ErrorDto(BaseModel):
    ...
    value: Optional[StrictStr] = Field(default=None, description="Сообщение об ошибке.")
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ErrorDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ErrorDto from an XML element"""
