...
class StoreBalance(BaseModel):
    ...
    StoreBalance
    """ # noqa: E501
    store: StrictStr = Field(description="ID склада")
    product: StrictStr = Field(description="ID товара")
    amount: Union[StrictFloat, StrictInt] = Field(description="Количественный остаток")
    sum: Union[StrictFloat, StrictInt] = Field(description="Денежный остаток")
    __properties: ClassVar[List[str]] = ["store", "product", "amount", "sum"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "StoreBalance",
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of StoreBalance from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of StoreBalance from an XML element"""
