...
class ProductsOperationResponseScheme(BaseModel):
    """
    ...
    response: Optional[List[ProductDto]] = Field(default=None, description="Список продуктов, которые подверглись изменениям.")
    __properties: ClassVar[List[str]] = ["result", "errors", "response"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "ProductsOperationResponseScheme",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductsOperationResponseScheme from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductsOperationResponseScheme from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": [ProductDto.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of ProductsOperationResponseScheme from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of ProductsOperationResponseScheme from an XML element"""
