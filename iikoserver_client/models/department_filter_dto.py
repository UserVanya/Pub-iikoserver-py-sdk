...
class DepartmentFilterDto(BaseModel):
    """
    DepartmentFilterDto
    """ # noqa: E501
    departments: Optional[List[StrictStr]] = Field(default=None, description="Список UUID подразделений.")
    excluding: Optional[StrictBool] = Field(default=None, description="Включающий или исключающий фильтр.")
    __properties: ClassVar[List[str]] = ["departments", "excluding"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "DepartmentFilterDto",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepartmentFilterDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepartmentFilterDto from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DepartmentFilterDto from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DepartmentFilterDto from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: excluding (XML name: excluding)
        # Handle XML element: excluding
        # Single element field: excluding
        child_element = element.find("excluding")
        if child_element is not None:
            # Check for null or empty values
            text_value = child_element.text
            if text_value is not None and text_value.strip() != "" and text_value != "null":
                data["excluding"] = text_value.lower() == 'true'
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: excluding (XML name: excluding)
        value = getattr(self, "excluding", None)
        if value is not None:  # Skip None values
            # Single element field: excluding
            child_element = SubElement(element, "excluding")
