...
class DeliveryRegionsReportXmlRows(BaseModel):
    """
    DeliveryRegionsReportXmlRows
    """ # noqa: E501
    row: Optional[List[DeliveryRegionRowXml]] = None
    __properties: ClassVar[List[str]] = ["row"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "DeliveryRegionsReportXmlRows",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryRegionsReportXmlRows from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryRegionsReportXmlRows from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "row": [DeliveryRegionRowXml.from_dict(_item) for _item in obj["row"]] if obj.get("row") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryRegionsReportXmlRows from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryRegionsReportXmlRows from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = DeliveryRegionRowXml.from_xml_element(child)
