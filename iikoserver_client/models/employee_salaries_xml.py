...
class EmployeeSalariesXml(BaseModel):
    """
    EmployeeSalariesXml
    """ # noqa: E501
    salary: Optional[List[EmployeeSalaryXml]] = Field(default=None, description="Список окладов сотрудников")
    __properties: ClassVar[List[str]] = ["salary"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "employeeSalaries",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmployeeSalariesXml from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in salary (list)
        _items = []
        if self.salary:
            for _item_salary in self.salary:
                if _item_salary:
                    _items.append(_item_salary.to_dict())
            _dict['salary'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmployeeSalariesXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "salary": [EmployeeSalaryXml.from_dict(_item) for _item in obj["salary"]] if obj.get("salary") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of EmployeeSalariesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of EmployeeSalariesXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: salary (XML name: salary)
        # Handle XML element: salary
        # Array field: salary
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("salary")
        items = []
        for child in child_elements:
            item_obj = EmployeeSalaryXml.from_xml_element(child)
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: salary (XML name: salary)
        value = getattr(self, "salary", None)
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "salary")
