...
class LogoutPostRequest(BaseModel):
    ...
    LogoutPostRequest
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Строка-токен, полученная при авторизации")
    __properties: ClassVar[List[str]] = ["key"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "LogoutPostRequest",
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of LogoutPostRequest from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of LogoutPostRequest from an XML element"""
