...
class AttendancesXml(BaseModel):
    """
    AttendancesXml
    """ # noqa: E501
    attendances: Optional[List[AttendanceXml]] = Field(default=None, description="Список явок")
    __properties: ClassVar[List[str]] = ["attendances"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "attendances",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttendancesXml from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttendancesXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "attendances": [AttendanceXml.from_dict(_item) for _item in obj["attendances"]] if obj.get("attendances") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of AttendancesXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of AttendancesXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: attendances (XML name: attendance)
        # Handle XML element: attendances
        # Array field: attendances
        # Non-wrapped array - direct elements
        # Complex items in non-wrapped array
        child_elements = element.findall("attendance")
        items = []
        for child in child_elements:
            item_obj = AttendanceXml.from_xml_element(child)
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: attendances (XML name: attendance)
        value = getattr(self, "attendances", None)
        if value is not None:  # Skip None values
            ...
            for item in value:
                ...
                if hasattr(item, "_to_xml_element_internal"):
                    item_element = SubElement(element, "attendance")
