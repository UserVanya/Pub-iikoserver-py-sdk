...
class FiscalStatus(str, Enum):
    """
    Признак фискальности оплаты:  FISCAL - Фискальный NOT_FISCAL - Не фискальный NO_PAYMENT - (без оплаты)
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FiscalStatus from a JSON string"""
        return cls(json.loads(json_str))

    @classmethod
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of FiscalStatus from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of FiscalStatus from an XML element"""
        if element is None:
            return None
