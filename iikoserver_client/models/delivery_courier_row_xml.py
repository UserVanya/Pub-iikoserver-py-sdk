...
class DeliveryCourierRowXml(BaseModel):
    """
    DeliveryCourierRowXml
    """ # noqa: E501
    courier: Optional[StrictStr] = Field(default=None, description="Курьер")
    metrics: Optional[DeliveryCourierRowXmlMetrics] = None
    __properties: ClassVar[List[str]] = ["courier", "metrics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXml from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if courier (nullable) is None
        # and model_fields_set contains the field
        if self.courier is None and "courier" in self.model_fields_set:
            _dict['courier'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXml from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "courier": obj.get("courier"),
            "metrics": DeliveryCourierRowXmlMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXml from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXml from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: courier (XML name: courier)
        # Handle XML element: courier
        # Single element field: courier
        child_element = element.find("courier")
        if child_element is not None:
            # Check for null or empty values
            text_value = child_element.text
            if text_value is not None and text_value.strip() != "" and text_value != "null":
                data["courier"] = text_value
        ...
        if child_element is not None:
            ...
            nested_obj = DeliveryCourierRowXmlMetrics.from_xml_element(child_element)
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: courier (XML name: courier)
        value = getattr(self, "courier", None)
        if value is not None:  # Skip None values
            # Single element field: courier
            child_element = SubElement(element, "courier")
