...
class OutgoingInvoiceXmlItems(BaseModel):
    """
    OutgoingInvoiceXmlItems
    """ # noqa: E501
    item: Optional[List[OutgoingInvoiceItemXml]] = Field(default=None, description="Позиции документа")
    __properties: ClassVar[List[str]] = ["item"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "OutgoingInvoiceXmlItems",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceXmlItems from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceXmlItems from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "item": [OutgoingInvoiceItemXml.from_dict(_item) for _item in obj["item"]] if obj.get("item") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceXmlItems from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of OutgoingInvoiceXmlItems from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = OutgoingInvoiceItemXml.from_xml_element(child)
