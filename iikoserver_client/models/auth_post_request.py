...
class AuthPostRequest(BaseModel):
    ...
    AuthPostRequest
    """ # noqa: E501
    login: StrictStr = Field(description="Логин пользователя")
    var_pass: StrictStr = Field(description="SHA1 хеш от пароля", alias="pass")
    __properties: ClassVar[List[str]] = ["login", "pass"]
    
    # XML metadata for the class
    __xml_config: ClassVar[Dict[str, Any]] = {
        "root_name": "AuthPostRequest",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthPostRequest from a dict"""
        if obj is None:
            return None
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of AuthPostRequest from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of AuthPostRequest from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        # Process field: var_pass (XML name: pass)
        # Handle XML element: var_pass
        # Single element field: var_pass
        child_element = element.find("pass")
        if child_element is not None:
            # Check for null or empty values
            text_value = child_element.text
            if text_value is not None and text_value.strip() != "" and text_value != "null":
                data["pass"] = text_value
    ...
    def _to_xml_element_internal(self, element: Element) -> None:
        ...
        # Process field: var_pass (XML name: pass)
        value = getattr(self, "var_pass", None)
        if value is not None:  # Skip None values
            # Single element field: var_pass
            child_element = SubElement(element, "pass")
            child_element.text = value
