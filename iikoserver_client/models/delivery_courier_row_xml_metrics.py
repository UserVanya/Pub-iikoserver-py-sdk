...
class DeliveryCourierRowXmlMetrics(BaseModel):
    """
    DeliveryCourierRowXmlMetrics
    """ # noqa: E501
    metric: Optional[List[DeliveryCourierMetricXml]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXmlMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXmlMetrics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metric": [DeliveryCourierMetricXml.from_dict(_item) for _item in obj["metric"]] if obj.get("metric") is not None else None
        })
        return _obj
    ...
    def from_xml(cls, xml_str: str) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXmlMetrics from an XML string"""
        try:
    ...
    def from_xml_element(cls, element: Element) -> Optional[Self]:
        """Create an instance of DeliveryCourierRowXmlMetrics from an XML element"""
    ...
    def _from_xml_element_internal(cls, element: Element) -> Optional[Self]:
        ...
        for child in child_elements:
            item_obj = DeliveryCourierMetricXml.from_xml_element(child)
